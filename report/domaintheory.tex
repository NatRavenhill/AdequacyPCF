...
Now we must prove three conditions to show $(\mathbbm{N}, \bot, \sqsubseteq)$ is a domain: 
...
Now we must prove three conditions to show that $\mathbbm{X \times Y}$ is a domain:
